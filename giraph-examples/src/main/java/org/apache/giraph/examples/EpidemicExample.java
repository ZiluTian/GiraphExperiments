...
public class EpidemicExample extends BasicComputation<
    LongWritable, DoubleArrayWritable, FloatWritable, DoubleWritable> {
  private static final Logger LOG =
      Logger.getLogger(EpidemicExample.class);
    ...
    public static final double infectiousBeta = 4d;
    public static final double symptomaticSkew = 2d;

    public static final int cfreq = 20;
            ...
            if (health == Infectious) {
              for (Edge<LongWritable, FloatWritable> edge : vertex.getEdges()) {
                  for (int i=0; i<cfreq; i++) {
                    ...
                    double selfRisk = 0;
                    if (health == Infectious) {
                        selfRisk = infectiousness(health, symptomatic);
                    } else {
                        selfRisk = 0;
                    }
