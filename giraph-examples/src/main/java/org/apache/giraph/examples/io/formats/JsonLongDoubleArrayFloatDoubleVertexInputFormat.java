...
/**
  ...
  */
public class JsonLongDoubleArrayFloatDoubleVertexInputFormat extends
  TextVertexInputFormat<LongWritable, DoubleArrayWritable, FloatWritable> {

  @Override
  public TextVertexReader createVertexReader(InputSplit split,
      TaskAttemptContext context) {
    return new JsonLongDoubleArrayFloatDoubleVertexReader();
  }
  ...
  * [1,4.3,[[2,2.1],[3,0.7]]]
  */
  class JsonLongDoubleArrayFloatDoubleVertexReader extends
    ...
    @Override
    protected DoubleArrayWritable getValue(JSONArray jsonVertex) throws
      ...
      for (int i = 0; i < jsonValueArray.length(); ++i) {
        states[i] = new DoubleWritable(jsonValueArray.getDouble(i));
      }
      return new DoubleArrayWritable(states);
    }
    ...
    @Override
    protected Vertex<LongWritable, DoubleArrayWritable, FloatWritable>
