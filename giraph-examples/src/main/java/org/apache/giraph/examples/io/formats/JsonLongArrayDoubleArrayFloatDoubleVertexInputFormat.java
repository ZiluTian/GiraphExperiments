...
/**
  ...
  * out-edge weights, and <code>Array[double]</code> message types,
  *  specified in JSON format.
  */
public class JsonLongArrayDoubleArrayFloatDoubleVertexInputFormat extends
  TextVertexInputFormat<LongWritable, ArrayDoubleArrayWritable, FloatWritable> {

  @Override
  public TextVertexReader createVertexReader(InputSplit split,
      TaskAttemptContext context) {
    return new JsonLongArrayDoubleArrayFloatDoubleVertexReader();
  }
  ...
  * [1,4.3,[[2,2.1],[3,0.7]]]
  */
  class JsonLongArrayDoubleArrayFloatDoubleVertexReader extends
    ...
    @Override
    protected ArrayDoubleArrayWritable getValue(JSONArray jsonVertex) throws
      JSONException, IOException {
      JSONArray jsonValueArray = jsonVertex.getJSONArray(1);
      // DoubleWritable states[] = new DoubleWritable[jsonValueArray.length()];
      DoubleArrayWritable states[] = new DoubleArrayWritable[jsonValueArray.length()];

      for (int i = 0; i < jsonValueArray.length(); ++i) {
        JSONArray nestedArray = jsonValueArray.getJSONArray(i);
        DoubleWritable ans[] = new DoubleWritable[nestedArray.length()];
        for (int j = 0; j < nestedArray.length(); ++j) {
          ans[j] = new DoubleWritable(nestedArray.getDouble(j));
        }
        states[i] = new DoubleArrayWritable(ans);
      }
      return new ArrayDoubleArrayWritable(states);
    }
    ...
    @Override
    protected Vertex<LongWritable, ArrayDoubleArrayWritable, FloatWritable>
